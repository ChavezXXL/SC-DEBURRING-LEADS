    ...
    >
      ...
      >
        <div className="mb-6 flex items-start justify-between">
          <div>
            <div className="mb-1 text-lg font-bold text-slate-100">Add New Lead</div>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="rounded-xl bg-apex-accent px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-orange-950/50 transition hover:brightness-110 disabled:opacity-50 disabled:hover:brightness-100"
          >
            Save Lead
          </button>
        </div>
