...
export function Sidebar({import React from 'react';
import {
  LayoutDashboard,
  MessageSquare,
  Check,
        ...
        <div className="border-t border-zinc-800/50 pt-5">
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={stat.label}
                onClick={() => onPipelineClick && onPipelineClick(stat.id)}
                className="flex cursor-pointer items-center justify-between rounded-md px-2 py-1 -mx-2 transition-colors hover:bg-zinc-800/50"
              >
