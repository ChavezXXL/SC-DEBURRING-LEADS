...
export function Sidebar({
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-30 flex h-screen w-64 shrink-0 flex-col justify-between overflow-y-auto border-r border-zinc-800/50 bg-zinc-950 p-6 transition-transform duration-300 md:static md:translate-x-0 md:bg-zinc-900/50 ${
        mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
      }`}
    >
      <div>
        <div className="mb-8 hidden items-center gap-3 md:flex">
          <FancyLogo className="h-10 w-10 drop-shadow-lg" />
          <div>
        ...
        <div className="border-t border-zinc-800/50 pt-5">
          ...
          <div className="space-y-3">
            {[
              { label: 'Total Leads', val: S.total, c: 'text-zinc-400', id: 'total' },
              ...
              <div
                ...
                className="mx-[-0.5rem] flex cursor-pointer items-center justify-between rounded-md px-2 py-1 transition-colors hover:bg-zinc-800/50"
              >
